    ...
    Card(
      ...
      Column(modifier = Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(6.dp)) {
        Row(
          ...
          Text(
              text = localizedString(R.string.mock_device_kit_title),
              style = MaterialTheme.typography.headlineSmall,
              fontWeight = FontWeight.Bold,
          )
          Text(
              text = localizedString(R.string.devices_paired_count, uiState.pairedDevices.size),
        ...
        Text(
            text = localizedString(R.string.mock_device_kit_description),
            style = MaterialTheme.typography.bodyMedium,
        ...
        ActionButton(
            modifier = Modifier.fillMaxWidth(),
            text = localizedString(R.string.pair_rayban_meta),
  ...
  Card(
    ...
    Column(modifier = Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(4.dp)) {
      ...
      Row(
        ...
        ActionButton(
            text = localizedString(R.string.unpair),
      ...
      Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(8.dp)) {
        ActionButton(
            text = localizedString(R.string.power_on),
            onClick = { viewModel.powerOn(deviceInfo) },
            modifier = Modifier.weight(1f),
        )
        ActionButton(
            text = localizedString(R.string.power_off),
      ...
      Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(8.dp)) {
        ActionButton(
            text = localizedString(R.string.unfold),
            onClick = { viewModel.unfold(deviceInfo) },
            modifier = Modifier.weight(1f),
        )
        ActionButton(
            text = localizedString(R.string.fold),
      ...
      Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(8.dp)) {
        ActionButton(
            text = localizedString(R.string.don),
            onClick = { viewModel.don(deviceInfo) },
            modifier = Modifier.weight(1f),
        )
        ActionButton(
            text = localizedString(R.string.doff),
      ...
      Row(
        ...
        ActionButton(
            text = localizedString(R.string.select_video),
            onClick = { videoPickerLauncher.launch("video/*") },
            modifier = Modifier.weight(1f),
        )
        StatusText(
            hasContent = deviceInfo.hasCameraFeed,
            positiveText = localizedString(R.string.has_camera_feed),
            negativeText = localizedString(R.string.no_camera_feed),
      ...
      Row(
        ...
        ActionButton(
            text = localizedString(R.string.select_image),
            onClick = { imagePickerLauncher.launch("image/*") },
            modifier = Modifier.weight(1f),
        )
        StatusText(
            hasContent = deviceInfo.hasCapturedImage,
            positiveText = localizedString(R.string.has_captured_image),
            negativeText = localizedString(R.string.no_captured_image),
            modifier = Modifier.weight(1f).padding(start = 8.dp),
        )
      }
    }
